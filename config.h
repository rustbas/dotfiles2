...
/* tagging */
static const char *tags[] = { "\uebca", "\uf488", "\uebaf", "\ueaeb", "1", "2", "3", "4", "󰵅", "\uf2c6"};
...
static const char *keyboard[]  = { "/home/rustam/new_dotfiles/scripts/keyboard.sh", NULL };

//static const char *printcmd[] = { "maim", "--select", "|", "xclip", "-selection", "clipboard", "-t", "image/png", NULL };
